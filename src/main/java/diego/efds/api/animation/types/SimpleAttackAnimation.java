...
public class SimpleAttackAnimation extends AttackAnimation {
    ...
    public SimpleAttackAnimation(float convertTime, float Start, float End, float recovery, InteractionHand hand, @Nullable Collider collider, Joint colliderJoint, String path, Armature armature) {
